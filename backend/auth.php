...
// ============================================
// TODO: Implement NUWebspace authentication here
// 
// For NUWebspace integration, you'll need to:
// 1. Replace the standard login/register with NUWebspace OAuth flow
// 2. Redirect users to NUWebspace login page
// 3. Handle the OAuth callback
// 4. Fetch user info from NUWebspace API
// 5. Create/update local user record
//
// Example OAuth flow:
// - User clicks "Login with NUWebspace"
// - Redirect to: NUWEBSPACE_API_URL/oauth/authorize?client_id=...&redirect_uri=...
// - NUWebspace redirects back with authorization code
...
function handleLogin($pdo, $input) {
    ...
    // TODO: Replace with NUWebspace OAuth flow
